...
//	}
	...
	@Info(name = "getUnUseBankcard_db", desc = "获取未使用的银行卡号码")
	@Param(type = { }, name = { }, desc = {  })
	@Return(type = "String", desc = "获取未使用的银行卡号码")
	public static void getUnUseBankcard_db(){
	}
	
	public static String getUnUseBankcard(String mySql_driver, String mySql_url, String db_name, String db_password) throws SQLException{
	...
	@Info(name = "getBankcardByBankName", desc = "根据银行名称获取银行卡号码")
	...
	@Info(name = "getUnUseBankcardByBankName_db", desc = "根据银行名称获取未使用的银行卡号码")
	@Param(type = {"String"}, name = {"bankName"}, desc = { "银行名称:银行英文简写，如：建设银行：CCB"})
	...
	public static String getUnUseBankcardByBankName(String mySql_driver, String mySql_url, String db_name,
			String db_password, String bankName) throws SQLException{
		String prefix = bankMap.get(bankName);
		String bankCard = BankCardUtils.getBankCard(prefix);
		Connection conn = DBUtils.getConnection(mySql_driver, mySql_url, db_name, db_password);
		String sql = "select count(*) from user_bankcard_info WHERE bank_card_no='" + bankCard + "'";
	...
	@Info(name = "getUsedBankcardByBankName_db", desc = "根据银行名称获取已使用的银行卡号码")
	@Param(type = {"String"}, name = {"bankName"}, desc = { "银行名称:银行英文简写，如：建设银行：CCB" })
	@Return(type = "String", desc = "test")
	...
	@Info(name = "getUseBankcardRandom_db", desc = "随机获取已经存在的银行卡号码")
	@Param(type = {  }, name = {  }, desc = { })
	@Return(type = "String", desc = "test")
	...
	@Info(name = "getBankcardByUserId_db", desc = "根据userId获得用户的银行卡号码")
